...
var overLayers = {
    "Earthquake Timelie": timelineLayer,
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson", function (data) {
    ...
    var getInterval = function(data) {
        // make a start and end time 
        return {
            start: data.properties.time,
            end: data.properties.time + data.properties.mag * 3600000
        };
    };
    ...
    var timeline = L.timeline(data, {
        ...
        pointToLayer: function(layerData, lat){
